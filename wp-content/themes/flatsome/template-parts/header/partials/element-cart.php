...
<a href="<?php echo esc_url( wc_get_cart_url() ); ?>" title="<?php _e('Cart', 'woocommerce'); ?>" class="header-cart-link cart-header <?php echo get_flatsome_icon_class($icon_style, 'small'); ?>">
